            ...
            <div className="w-full grid grid-cols-3 py-4">
              <div className="flex gap-4">
                <button
                  ...
                  type="button"
                  className={`h-full py-2 px-4 bg-gray-400 flex justify-center items-center text-white rounded ${
                    !filter  && "bg-gray-500"
                  }`}
                >
                  All
                ...
                <button
                  ...
                  type="button"
                  className={`h-full py-2 px-2 bg-gray-400 flex justify-center items-center text-white rounded ${
                    filter === 1 && "bg-gray-500"
                  } `}
                >
                  Dịch vụ chính
                </button>
                  ...
                  {serviceData
                    ?.filter((item) => {
                      if (nameServiceFilter) {
                        return item.TenDichVu.toLowerCase().includes(
                          nameServiceFilter.toLowerCase()
                        );
                      } else {
                        return item;
                      }
