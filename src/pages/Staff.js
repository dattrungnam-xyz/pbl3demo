    ...
    {data?.filter((item)=>{
      ...
      return (<>
       ...
       <div className="flex flex-col  items-center justify-center ">
        ...
        <p className="py-2 text-lg text-white">{item.NamKinhNghiem} Năm kinh nghiệm</p>
      ...
      <div className=" flex flex-col flex-1 items-center justify-center text-white  border-white border-[4px] py-8 px-8 max-lg:px-6 max-lg:py-6 min-w-[360px]">
        ...
        <p className="py-2 text-lg">
          ...
          sẽ được tư vấn tạo kiểu tóc phù hợp với khuôn mặt bởi các barber giàu
          kinh nghiệm và thân thiện, mang đến trải nghiệm dịch vụ chuyên nghiệp
          mà vẫn ấm cúng.
        </p>
      </div>
    </div>
